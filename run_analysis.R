...
#1.Merge the training and test sets to create one data set(Subject Data Set)
...
# subsetting and correcting column names
x_data <- x_data[, mean_and_std_features]
names(x_data) <- features_data[mean_and_std_features, 2]
...
# binding all the data into one data set
